	...
	Raphael.fn.group = function(f, g) {
		if(Raphael.svg == true) {
			...
			var transformString = function() {
				let matrix = "matrix(" + thisTransform.translate.x + "," + thisTransform.translate.y + ") scale(" + thisTransform.scale.x + "," + thisTransform.scale.y + ") rotate(" + thisTransform.rotate.x + "," + thisTransform.rotate.y + "," + thisTransform.rotate.z + ")"
				matrix = matrix.replace(/\,undefined/, "");
				return matrix;
			};
